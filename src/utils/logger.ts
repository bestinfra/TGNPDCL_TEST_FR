...
// Override console methods to use file logger instead - NO console output
if (typeof window !== 'undefined') {
  ...
  console.error = (...args: any[]) => {
    ...
    // Console output disabled - logs go to files only
  };
  ...
  // Override console.log - suppress all log output
  console.log = (...args: any[]) => {
    ...
    // Log to files as info level, but don't show in console
    logger.info(message, context);
    // Console output disabled - logs go to files only
  };

  // Override console.info - suppress all info output
  ...
  // Override console.debug - suppress all debug output
  ...
  // Override console.trace - suppress all trace output
